  ...
  return {
    ...
    pwa: {
      ...
      extendManifestJson(json) {
        json.name = 'Eletrofeu Player';
        json.short_name = 'Eletrofeu';
        json.description = 'Media Player com drawer lateral para controles';
